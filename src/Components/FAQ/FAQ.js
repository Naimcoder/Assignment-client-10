...
<section className="bg-gray-800 text-gray-100">
	<div className="container flex flex-col justify-center p-4 mx-auto md:p-8">
		...
		<div className="flex flex-col lg:text-2xl divide-y sm:px-8 lg:px-12 xl:px-32 divide-gray-700">
			...
			<details>
				<summary className="py-2 outline-none cursor-pointer focus:underline">What is PHP?</summary>
				<div className="px-4 pb-4">
...
systems and has also been ported to Java and .NET virtual machines.</p>
				</div>
			</details>
		</div>
	</div>
